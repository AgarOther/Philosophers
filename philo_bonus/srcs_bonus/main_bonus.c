...
/*   Updated: 2026/02/27 11:11:07 by scraeyme         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	i = 0;
	get_philos(&data, &i);
	if (!data.philos || !data.status_lock || i != data.rules.philo_count)
	{
		printf("\033[31;1mError allocating mutexes/philosophers.\033[0m\n");
		free_data(&data);
		return (1);
	}
	philoop(&data, 0, 0, 0);
